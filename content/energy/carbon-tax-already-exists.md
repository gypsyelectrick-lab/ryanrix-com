...
date: 2026-07-21
author: "Max Weber"
description: "Fuel taxes already price CO2 at £229 per tonne - above every official estimate of the damage. The carbon tax you keep hearing about was already there."
draft: false
weight: 20
...
## What a Carbon Tax Is Supposed to Do
...
This is the opposite of how climate policy is actually done. Real climate policy involves thousands of pages of regulations, dozens of subsidy programs, a carbon trading system that even its creators cannot explain, and endless political fights over which industries deserve exemptions.

All of that complexity exists because the simple solution was never tried. But here is the uncomfortable truth: it was not tried because it had already been done.

---

## The Tax You Did Not Know You Were Paying

The United Kingdom applies a fuel duty of 52.95 pence on every litre of petrol and diesel sold. This tax has existed in various forms since 1909. It was originally introduced to fund road construction. It has nothing to do with climate.

But it has the exact same effect as a carbon tax.

One litre of petrol produces about 2.31 kilograms of CO2 when burned. The fuel duty on that litre is 52.95 pence. Divide the tax by the emissions:
...
The same is true in France, where the TICPE fuel excise plus VAT produces an effective carbon price of roughly **€280 to €368 per tonne**, depending on the fuel. It is true in Australia, Canada, and across most of Europe. Every one of these countries has been charging a carbon tax for decades without calling it one.

---

## What This Means for Climate Policy

If the goal is to price carbon at its social cost, the goal has already been achieved in most developed countries. The carbon externality of road fuel is fully priced, and in many cases overpriced, by taxes that existed before anyone worried about CO2.

This changes everything about how you should think about climate policy.
...
## The Carbon Trading Nonsense

If a simple tax was too obvious, a carbon trading system was the next worst idea.
...
If the solution is so straightforward, why does almost no government pursue it?

Part of the answer is that fuel duty is not perceived as a climate policy. It is perceived as a tax on driving. A politician who says "we already tax carbon at £229 per tonne through existing fuel duties" is not understood. A politician who says "we will introduce a carbon tax to save the planet" gets headlines, even if the new tax is redundant.

Part of the answer is that fuel duty was never intended to be a climate policy, so it does not vary with climate science. If you think the social cost of carbon is $50 per tonne, you are massively overtaxing fuel. If you think it is $500 per tonne, you are in the right ballpark but could go higher. The tax exists for historical reasons and no one adjusts it based on the latest IPCC report.

But the biggest part of the answer is that the climate policy machine needs complexity to survive.

A simple carbon tax requires no bureaucrats to administer, no consultants to design, no traders to speculate, no academics to study, and no activists to campaign for. It is a single price signal that operates automatically. The people who have built careers on climate policy cannot build careers on a single price signal. They need the subsidies, the trading schemes, the offset protocols, the renewable energy certificates, the green hydrogen strategies, the net-zero frameworks. Every layer of complexity creates a new job, a new consulting contract, a new grant application, a new lobbying opportunity.

This is the same institutional incentive structure that drives every other area of government growth. The machine exists to sustain itself, not to solve the problem efficiently.
...
The same dynamic is playing out across Europe, Canada, and Australia. Every time a government adds a carbon tax on top of existing fuel duties, it is adding a redundant tax to a product whose carbon cost is already priced. The public senses this, even if they cannot articulate the math. They believe they are being taxed twice for the same thing. They are right.

---

## What a Sensible Policy Would Look Like

If you accept the premise that CO2 emissions cause climate damage and should be priced, a sensible policy is straightforward:
...
This is not what any government has done. What governments have done is the opposite: add new carbon taxes on top of existing fuel taxes, keep the subsidies, keep the trading system, and create a policy that punishes the same activity through four different channels while pretending each one is a separate solution.

---

## The Question

The idea of a carbon tax is one of the few genuinely elegant ideas in climate policy. It is simple, efficient, and would work if applied correctly.
...
**The solution was already there. The question is why nobody wanted to admit it.**

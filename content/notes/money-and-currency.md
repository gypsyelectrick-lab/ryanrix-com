...
|-----------|---------|--------------|-------------|
| **D**urable | Does not rot or degrade | Gold | Fish |
| **A**cceptable | Everyone agrees to take it | Dollars | Beanie Babies |
| **D**ivisible | Can be split into small units | Digital currency | A cow |
| **P**ortable | Easy to carry around | A banknote | Gold bars |
| **H**omogeneous | One unit is the same as another | A dollar bill | Diamonds (all different) |
| **I**dentifiable | You can tell real from fake | A modern banknote | Cowrie shells |
| **S**carce | Cannot be created at will | Bitcoin (fixed supply) | Seashells on a beach |

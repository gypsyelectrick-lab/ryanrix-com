...
If you want to understand why a government would keep raising a rate its own forecaster said would raise almost nothing, the answer is not in the spreadsheet. It is in the incentives - the same ones documented in <a href="/economics/incentives-matter-the-economics-of-obvious/" target="_blank" rel="noopener noreferrer">Incentives Matter: The Economics of Obvious</a>. Politicians are rewarded for the gesture. The bill arrives later, and somebody else pays it. That is not a bug in the system. It is the system.

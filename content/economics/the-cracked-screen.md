...
{{< quote author="Henry Hazlitt" >}}
"It is the first principle of economics that every action has unintended consequences."
{{< /quote >}}
...
1. **"And then what?"** - trace the effects past the first obvious result.
2. **"Who else is affected?"** - look past the visible winners to find the invisible losers.
